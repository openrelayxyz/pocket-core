...
func (m *MsgNodeStake) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgNodeStake.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *MsgNodeStake) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgNodeStake.Merge(m, src)
}
func (m *MsgNodeStake) XXX_Size() int {
	return m.Size()
}
func (m *MsgNodeStake) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgNodeStake.DiscardUnknown(m)
}

var xxx_messageInfo_MsgNodeStake proto.InternalMessageInfo

type MsgBeginUnstake struct {
	ValidatorAddress github_com_pokt_network_pocket_core_types.Address `protobuf:"bytes,1,opt,name=validatorAddress,proto3,casttype=github.com/pokt-network/pocket-core/types.Address" json:"validator_address" yaml:"validator_address"`
}
...
type MsgSend struct {
	...
	Amount      github_com_pokt_network_pocket_core_types.Int     `protobuf:"bytes,3,opt,name=amount,proto3,customtype=github.com/pokt-network/pocket-core/types.Int" json:"amount" yaml:"amount"`
}
...
var fileDescriptor_0de9b62fa75e413f = []byte{
	...
	,
}
...
func (m *MsgBeginUnstake) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValidatorAddress) > 0 {
		...
		i = encodeVarintMsg(dAtA, i, uint64(len(m.ValidatorAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
