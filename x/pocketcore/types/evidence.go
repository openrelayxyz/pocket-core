...
type Evidence struct {
	...
	SessionHeader `json:"evidence_header"`                // the session h serves as an identifier for the GOBEvidence
	NumOfProofs   int64        `json:"num_of_proofs"`     // the total number of proofs in the GOBEvidence
