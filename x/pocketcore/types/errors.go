...
var (
	...
	NoEvidenceTypeErr                = errors.New("the EvidenceEncodable type is not supplied in the claim message")
	InvalidPkFileErr                 = errors.New("the PK File is not found")
	InvalidEvidenceErr               = errors.New("the EvidenceEncodable type passed is not valid")
