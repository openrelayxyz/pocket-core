...
type AppModuleBasic interface {
	Name() string
	RegisterCodec(amino *codec.LegacyAmino, proto *codec.ProtoCodec)
...
func (bm BasicManager) RegisterCodec(amino *codec.LegacyAmino, proto *codec.ProtoCodec) {
	for _, b := range bm {
		b.RegisterCodec(amino, proto)
	}
}
